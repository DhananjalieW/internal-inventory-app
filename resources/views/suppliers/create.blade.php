<x-app-layout>
  <div class="container py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
      <div>
        <h1 class="mb-1 fw-bold" style="font-size: 2rem; color: #1a202c;">New Supplier</h1>
        <p class="text-muted mb-0" style="font-size: 0.95rem;">
          <i class="bi bi-truck me-1"></i>Create a supplier profile for purchasing
        </p>
      </div>
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 12px;">
      ...
      <div class="card-body p-4">
        <form method="POST" action="{{ route('suppliers.store') }}" class="vstack gap-4">
          @csrf
              ...
              <div class="d-flex flex-column gap-2">
                <div class="form-check p-0">
                  <input type="radio" name="is_active" value="1" id="status_active" 
                         class="btn-check" {{ old('is_active','1')=='1'?'checked':'' }}>
                ...
                <div class="form-check p-0">
                  <input type="radio" name="is_active" value="0" id="status_inactive" 
                         class="btn-check" {{ old('is_active')=='0'?'checked':'' }}>
          ...
          <div>
            ...
            <div class="position-relative">
              ...
              <textarea name="address" rows="4" 
                        ...
                        style="border: 2px solid #e5e7eb; border-radius: 10px; padding: 12px 16px 12px 40px;">{{ old('address') }}</textarea>
              @error('address')
                <div class="invalid-feedback d-flex align-items-center gap-2 mt-2">
                  <i class="bi bi-exclamation-circle"></i>{{ $message }}
                </div>
