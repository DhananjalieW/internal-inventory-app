<x-app-layout>
  <div class="container py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
      <div>
        <h1 class="mb-1 fw-bold" style="font-size: 2rem; color: #1a202c;">Edit Supplier</h1>
        <p class="text-muted mb-0" style="font-size: 0.95rem;">
          <i class="bi bi-pencil-square me-1"></i>Update supplier contact and status
          <span class="badge px-2 py-1 ms-2" style="background: #f3f4f6; color: #1a202c; border-radius: 6px; font-weight: 500; font-size: 0.8rem;">
            {{ $supplier->name }}
          </span>
        </p>
      </div>
      <a class="btn btn-outline-secondary d-flex align-items-center gap-2 px-4 py-2 mt-3 mt-md-0" href="{{ route('suppliers.index') }}" style="border-radius: 10px; font-weight: 500; border: 2px solid #e5e7eb;">
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 12px;">
      <div class="card-header bg-white border-0 pt-4 px-4">
        <h5 class="mb-0 fw-bold" style="color: #1a202c;">Supplier Information</h5>
      </div>
      
      <div class="card-body p-4">
        <form method="POST" action="{{ route('suppliers.update',$supplier) }}" class="vstack gap-4">
          @csrf @method('PUT')
          ...
          <div class="row g-4">
            <div class="col-md-4">
              <label class="form-label small text-muted fw-semibold mb-2">Email</label>
              <div class="position-relative">
                <span class="position-absolute top-50 start-0 translate-middle-y ms-3 text-muted">
            ...
            <div class="col-md-4">
              <label class="form-label small text-muted fw-semibold mb-2">Phone</label>
              <div class="position-relative">
                <span class="position-absolute top-50 start-0 translate-middle-y ms-3 text-muted">
            ...
            <div class="col-md-4">
              <label class="form-label small text-muted fw-semibold mb-2">Status</label>
              <div class="d-flex flex-column gap-2">
                <div class="form-check p-0">
                  <input type="radio" name="is_active" value="1" id="status_active" 
                         class="btn-check" {{ old('is_active',$supplier->is_active)?'checked':'' }}>
              ...
              @error('is_active')
                <div class="text-danger small d-flex align-items-center gap-2 mt-2">
                  <i class="bi bi-exclamation-circle"></i>{{ $message }}
                </div>
              @enderror
            </div>
          ...
          {{-- Address --}}
          <div>
            <label class="form-label small text-muted fw-semibold mb-2">Address</label>
            <div class="position-relative">
              ...
              <textarea name="address" rows="4" 
                        ...
                        style="border: 2px solid #e5e7eb; border-radius: 10px; padding: 12px 16px 12px 40px;">{{ old('address',$supplier->address) }}</textarea>
              @error('address')
                <div class="invalid-feedback d-flex align-items-center gap-2 mt-2">
                  <i class="bi bi-exclamation-circle"></i>{{ $message }}
                </div>
          ...
          <div class="d-flex justify-content-end gap-3">
            <a class="btn btn-outline-secondary px-4 py-2" href="{{ route('suppliers.index') }}" style="border-radius: 10px; font-weight: 500; border: 2px solid #e5e7eb;">
              Cancel
            </a>
