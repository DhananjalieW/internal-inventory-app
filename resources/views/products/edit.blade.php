<x-app-layout>
  <div class="container py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
      <div>
        <h1 class="mb-1 fw-bold" style="font-size: 2rem; color: #1a202c;">Edit Product</h1>
        <p class="text-muted mb-0" style="font-size: 0.95rem;">
          <i class="bi bi-pencil-square me-1"></i>Update product information
              ...
              <div class="d-flex gap-3">
                <div class="form-check p-0">
                  <input type="radio" name="is_active" value="1" id="status_active" 
                         class="btn-check" @checked(old('is_active',$product->is_active)==1)>
                ...
                <div class="form-check p-0">
                  <input type="radio" name="is_active" value="0" id="status_inactive" 
                         class="btn-check" @checked(old('is_active',$product->is_active)==0)>
