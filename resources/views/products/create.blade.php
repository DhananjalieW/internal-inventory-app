            ...
            <div class="form-group">
              ...
              <div class="input-wrapper">
                ...
                <input
                  type="text"
                  name="sku"
                  class="form-input readonly @error('sku') is-invalid @enderror"
                  placeholder="Auto-generated"
                  value="{{ old('sku', $nextSku ?? '') }}"
                  readonly
                >
              </div>
              <div class="form-helper">
                <i class="bi bi-info-circle"></i>
                SKU will be auto-generated (e.g., PRD-00001)
              </div>
              @error('sku')
