<x-app-layout>
  <div class="container py-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
      <div>
        <h1 class="mb-1 fw-bold" style="font-size: 2rem; color: #1a202c;">Edit Warehouse</h1>
        <p class="text-muted mb-0" style="font-size: 0.95rem;">
          <i class="bi bi-pencil-square me-1"></i>Update warehouse details
          <span class="badge px-2 py-1 ms-2" style="background: #f3f4f6; color: #1a202c; border-radius: 6px; font-weight: 500; font-size: 0.8rem; font-family: 'Courier New', monospace;">
            {{ $warehouse->code }}
          </span>
        </p>
      </div>
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 12px;">
      ...
      <div class="card-body p-4">
        <form method="POST" action="{{ route('warehouses.update',$warehouse) }}" class="row g-4">
          @csrf @method('PUT')
            ...
            <div class="d-flex flex-column gap-2">
              <div class="form-check p-0">
                <input type="radio" name="is_active" value="1" id="status_active" 
                       class="btn-check" @checked(old('is_active',$warehouse->is_active)==1)>
              ...
              <div class="form-check p-0">
                <input type="radio" name="is_active" value="0" id="status_inactive" 
                       class="btn-check" @checked(old('is_active',$warehouse->is_active)==0)>
