<x-app-layout>
  <div class="container py-4">
      ...
      <div class="alert alert-warning border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #fff3cd 0%, #fff8e1 100%); border-radius: 12px;">
        <div class="d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center gap-3">
            ...
            <span class="fw-medium">There are <strong>{{ $lowStockCount }}</strong> items below reorder level</span>
          </div>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      <div>
        <h1 class="mb-1 fw-bold" style="font-size: 2rem; color: #1a202c;">Admin Dashboard</h1>
        <p class="text-muted mb-0" style="font-size: 0.95rem;">
          <i class="bi bi-speedometer2 me-1"></i>Overview, status & quick actions
        </p>
      </div>

      <div class="d-flex flex-wrap gap-2 mt-3 mt-md-0">
        <a class="btn btn-outline-secondary d-flex align-items-center gap-2 px-3 py-2" href="{{ route('movements.create') }}" style="border-radius: 8px; font-weight: 500; border: 2px solid #e5e7eb;">
          <i class="bi bi-arrow-left-right"></i>Record movement
        </a>
        <a class="btn btn-outline-secondary d-flex align-items-center gap-2 px-3 py-2" href="{{ route('pos.create') }}" style="border-radius: 8px; font-weight: 500; border: 2px solid #e5e7eb;">
          <i class="bi bi-receipt"></i>New PO
        </a>
        <a class="btn btn-outline-secondary d-flex align-items-center gap-2 px-3 py-2" href="{{ route('admin.users.index') }}" style="border-radius: 8px; font-weight: 500; border: 2px solid #e5e7eb;">
    ...
    <div class="d-flex align-items-center gap-3 flex-wrap mb-4 p-3" style="background: #f8f9fa; border-radius: 12px;">
      <span class="badge d-flex align-items-center gap-2 px-3 py-2" style="background: #e8f5e9; color: #2e7d32; font-weight: 500; font-size: 0.9rem; border-radius: 8px;">
        <i class="bi bi-arrow-down-circle"></i>IN: {{ $mvSummary['IN'] ?? 0 }}
      </span>
      <span class="badge d-flex align-items-center gap-2 px-3 py-2" style="background: #ffebee; color: #c62828; font-weight: 500; font-size: 0.9rem; border-radius: 8px;">
        <i class="bi bi-arrow-up-circle"></i>OUT: {{ $mvSummary['OUT'] ?? 0 }}
      </span>
      <span class="badge d-flex align-items-center gap-2 px-3 py-2" style="background: #e3f2fd; color: #1565c0; font-weight: 500; font-size: 0.9rem; border-radius: 8px;">
        <i class="bi bi-sliders"></i>ADJUST: {{ $mvSummary['ADJUST'] ?? 0 }}
      </span>
      <a href="{{ route('reports.movements', ['range'=>'7d']) }}" class="ms-2 text-decoration-none fw-medium" style="font-size: 0.9rem;">
        View movements (7d) <i class="bi bi-arrow-right ms-1"></i>
      </a>
    </div>
    ...
    <div class="row g-3 mb-4">
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; transition: transform 0.2s;">
          <div class="card-body p-4">
            ...
            <div class="text-muted small mb-1" style="font-weight: 500;">Users</div>
            <div class="h2 mb-2 fw-bold" style="color: #1a202c;">{{ $usersCount }}</div>
            <a href="{{ route('admin.users.index') }}" class="small text-decoration-none fw-medium">Open users <i class="bi bi-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; transition: transform 0.2s;">
          <div class="card-body p-4">
            ...
            <div class="text-muted small mb-1" style="font-weight: 500;">Products</div>
            <div class="h2 mb-2 fw-bold" style="color: #1a202c;">{{ $productsCount }}</div>
            <a href="{{ route('products.index') }}" class="small text-decoration-none fw-medium">Open products <i class="bi bi-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; transition: transform 0.2s;">
          <div class="card-body p-4">
            ...
            <div class="h2 mb-2 fw-bold" style="color: #1a202c;">{{ $warehousesCount }}</div>
            <a href="{{ route('warehouses.index') }}" class="small text-decoration-none fw-medium">Open warehouses <i class="bi bi-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; transition: transform 0.2s;">
          <div class="card-body p-4">
            ...
            <div class="text-muted small mb-1" style="font-weight: 500;">Open POs</div>
            <div class="h2 mb-2 fw-bold" style="color: #1a202c;">{{ $openPoCount }}</div>
            <a href="{{ route('pos.index') }}" class="small text-decoration-none fw-medium">View POs <i class="bi bi-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; transition: transform 0.2s;">
          <div class="card-body p-4">
            ...
            <div class="text-muted small mb-1" style="font-weight: 500;">Low stock</div>
            <div class="h2 mb-2 fw-bold" style="color: #1a202c;">{{ $lowStockCount }}</div>
            <a href="{{ route('reorder.index') }}" class="small text-decoration-none fw-medium">Reorder report <i class="bi bi-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-6 col-md-4 col-lg-2">
        <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; transition: transform 0.2s;">
          <div class="card-body p-4">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <div class="d-flex align-items-center justify-content-center" style="width: 48px; height: 48px; background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); border-radius: 12px;">
                <i class="bi bi-check2-circle text-white fs-5"></i>
              </div>
            </div>
            <div class="text-muted small mb-1" style="font-weight: 500;">Pending approvals</div>
            <div class="h2 mb-2 fw-bold" style="color: #1a202c;">{{ $pendingApprovals }}</div>
            <a href="{{ route('admin.approvals.index') }}" class="small text-decoration-none fw-medium">Open approvals <i class="bi bi-arrow-right ms-1"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-4">
                ...
                <tbody>
                  @forelse ($lowStock as $r)
                    <tr style="border-bottom: 1px solid #f1f3f5;">
                      <td class="px-4 py-3">
                        <a class="fw-bold text-decoration-none" href="{{ route('products.edit',$r->product_id) }}" style="color: #1a202c; font-family: 'Courier New', monospace; font-size: 0.9rem;">
                          {{ $r->sku }}
                        </a>
                      </td>
                      <td class="py-3">
                      ...
                      <td class="py-3 text-end">
                        <span class="fw-semibold" style="color: #6b7280;">{{ $r->reorder_point }}</span>
                      </td>
      ...
      {{-- Right column: stock by wh + recent activity --}}
      <div class="col-lg-5 d-flex flex-column gap-4">
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
          <div class="card-header bg-white border-0 pt-4 px-4">
            <h5 class="mb-0 fw-bold" style="color: #1a202c;">Recent Activity</h5>
          </div>
          <div class="card-body p-4">
            @forelse($recent->take(5) as $a)
              <div class="d-flex align-items-start gap-3 mb-3">
                <div class="d-flex align-items-center justify-content-center flex-shrink-0" style="width: 32px; height: 32px; background: #f8f9fa; border-radius: 8px;">
                  <i class="bi bi-activity text-muted"></i>
                </div>
                <div class="flex-grow-1">
                  <div class="fw-medium small mb-1" style="color: #1a202c;">{{ $a->event }}</div>
    ...
    {{-- Movers + recent movements --}}
    <div class="row g-4 mt-1">
      <div class="col-lg-7">
        <div class="card border-0 shadow-sm" style="border-radius: 12px;">
          <div class="card-header bg-white border-0 pt-4 px-4">
            <h5 class="mb-0 fw-bold" style="color: #1a202c;">Top movers (30d)</h5>
          </div>
          <div class="card-body p-0 pb-3">
            <table class="table align-middle mb-0">
              <thead style="background: #f8f9fa;">
                <tr>
                  <th class="border-0 text-muted small fw-semibold py-3 px-4">SKU</th>
                  <th class="border-0 text-muted small fw-semibold py-3">Name</th>
                  <th class="border-0 text-muted small fw-semibold py-3 text-end px-4">Moves</th>
                </tr>
              </thead>
              <tbody>
                @forelse($topMovers as $m)
                  <tr style="border-bottom: 1px solid #f1f3f5;">
                    <td class="px-4 py-3">
                      <span class="fw-medium" style="color: #1a202c; font-family: 'Courier New', monospace;">{{ $m->product->sku ?? '' }}</span>
                    </td>
                    <td class="py-3">
                      <span style="color: #1a202c;">{{ $m->product->name ?? '' }}</span>
                    </td>
                    <td class="py-3 text-end px-4">
                      <span class="fw-bold" style="color: #1a202c;">{{ $m->cnt }}</span>
                    </td>
                  </tr>
                @empty
                  <tr>
                    <td colspan="3" class="text-center py-3 px-3">
              ...
              <tbody>
                @forelse($recentMovements as $mv)
                  <tr style="border-bottom: 1px solid #f1f3f5;">
                    ...
                    <td class="py-3">
                      <span class="fw-semibold small" style="color: #1a202c; font-family: 'Courier New', monospace;">{{ $mv->product->sku ?? '' }}</span>
                    </td>
                    <td class="py-3">
                      <span class="small text-muted">{{ $mv->warehouse->code ?? '' }}</span>
                    </td>
                    <td class="py-3 text-end px-4">
                      <span class="fw-bold small" style="color: #1a202c;">{{ $mv->qty }}</span>
                    </td>
                  </tr>
                @empty
                  <tr>
